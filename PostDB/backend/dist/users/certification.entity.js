...
__decorate([
    (0, typeorm_1.ManyToOne)(() => users_entity_1.User, user => user.certifications),
    (0, typeorm_1.JoinColumn)({ name: 'user_id' }),
    __metadata("design:type", users_entity_1.User)
], Certification.prototype, "user", void 0);
__decorate([
    (0, typeorm_1.Column)({ name: 'certification_name' }),
    __metadata("design:type", String)
], Certification.prototype, "certificationName", void 0);
__decorate([
    (0, typeorm_1.Column)({ name: 'issued_date', type: 'date' }),
